...
* `Part 1` – Linear and Logistic Regression with Gradient Descent Algorithm
* `Part 2` – Support Vector Classification with Linear, Radial and Polynomial Kernel, Decision Tree Classifier, Pruned Decision Tree Classifier, and AdaBoost Decision Tree Classifier
* `Part 3` – k-Nearest Neighbors Classifier, Artificial Neural Network Classifier
